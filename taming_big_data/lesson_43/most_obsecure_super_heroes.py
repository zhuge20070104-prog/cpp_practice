...
spark = SparkSession.builder.appName("MostObsecureSuperHeroes").getOrCreate()
...
names = spark.read.schema(schema).option("sep", " ").csv("file:///mnt/c/code/cpp_practice/taming_big_data/datasets/Marvel+Names")
