...
public:
    ...
    BoxContainer(BoxContainer<T>&& src) noexcept;
    BoxContainer& operator=(BoxContainer<T>&& src) noexcept;
    ...
    BoxContainer<T>& operator=(const BoxContainer<T>& src);
...
BoxContainer<T>::BoxContainer(BoxContainer<T>&& src) noexcept {
    ...
    m_capacity = src.m_capacity;
    src.invalidate();
    std::cout << "Move constructor successful\n";
}
