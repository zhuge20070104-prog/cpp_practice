...
struct str_num_conv_demo_t {
    ...
    void str_2_int() {
        ...
        // Resulting unsigned long and long long underflow
...
int main(int argc, char* argv[]) {
    str_num_conv_demo_t sn_demo;
    sn_demo(op_t::NUM_2_STR);
    sn_demo(op_t::STR_2_INT);
    sn_demo(op_t::STR_2_DOUBLE);
