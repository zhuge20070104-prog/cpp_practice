...
public:
    ...
    CivilEngineer(std::string_view fullname, int age, std::string_view address, int contact_count, 
        std::string_view specialilty);
    ~CivilEngineer() {
        std::cout << "CivilEngineer is destroyed\n";
    }
