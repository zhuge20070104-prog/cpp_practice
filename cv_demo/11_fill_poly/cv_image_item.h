...
public:
    ...
    Q_INVOKABLE void drawConvexPoly(cv::Mat const& srcMat);
    Q_INVOKABLE void drawPoly(cv::Mat const& srcMat);
    Q_INVOKABLE void drawPolyLines(cv::Mat const& srcMat, int is_closed);
