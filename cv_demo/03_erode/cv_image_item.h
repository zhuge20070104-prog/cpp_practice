...
public:
    ...
    Q_INVOKABLE void erodeMat(cv::Mat const& srcMat, int kernel_size);
    Q_INVOKABLE void dilateMat(cv::Mat const& srcMat, int kernel_size);
    Q_INVOKABLE void tidyMat(cv::Mat const& srcMat, int kernel_size);
