...
public:
    ...
    Q_INVOKABLE void sobelMat(cv::Mat const& srcMat, int dx, int dy, int kernel_size, int scale_factor, int delta_value);
    Q_INVOKABLE void laplacianMat(cv::Mat const& srcMat, int scale_factor, int delta_value);
